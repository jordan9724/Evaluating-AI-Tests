...
class CNNReplay(ModelBase):
    ...
    def __init__(self, load_from_num=None):
        ...
        # Other settings
        self.session = None
        self.load_from_num = load_from_num
        self.save_info = None
    ...
    def save_model(self):
        if self.save_info is None:
            self.save_info = SaveInfo(save_type='weights', save_num=self.load_from_num,
                                      extra_info='cnn_replay_h{}.dump'.format(self.handicap))
